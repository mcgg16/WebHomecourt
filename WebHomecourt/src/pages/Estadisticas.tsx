  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <div className='px-14 py-5 bg-zinc-100 w-full'>
        <div className="w-full px-5 py-7 bg-violet-950 rounded-2xl shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] outline outline-black/25 inline-flex flex-col justify-start items-start">
